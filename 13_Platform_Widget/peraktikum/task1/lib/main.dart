...
class HomePage extends StatelessWidget {
  ...
  Widget body() {
    return ListView(
      ...
      children: const [
        ChatItem(widget: FlutterLogo(size: 40), initial: '', title: 'Flutter Indonesia', sender: 'User 3', message: 'Hello ??', time: '22:14', mute: false, unread: 1280, color: Colors.transparent),
        ChatItem(widget: FlutterLogo(size: 40), initial: '', title: 'Flutter', sender: '', message: 'Hallo semua', time: '9:28', mute: true, unread: 8, color: Colors.transparent),
        ChatItem(widget: FlutterLogo(), initial: 'U1', title: 'User 2', sender: '', message: 'Tetap Semangat', time: '7:34', mute: false, unread: 2, color: kOrangeColor),
        ChatItem(widget: FlutterLogo(), initial: 'U2', title: 'Pengguna 3', sender: '', message: 'Hi, how are you ?', time: 'Tue', mute: true, unread: 0, color: kGreenPeasColor),
      ],
    );
  }
